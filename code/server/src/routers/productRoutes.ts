    ...
    initRoutes() {
        ...
        this.router.post(
            "/",[
                ...
                body("category").isString().isIn(["Appliance","Laptop","Smartphone"]),
        ...
        this.router.get(
            "/",[
                ...
                query("category").optional().isString().isIn(["Appliance","Laptop","Smartphone"]),
                query("model").optional().isString().notEmpty(),
                query("grouping").custom((grouping, { req }) => {
                    const { category, model } = req.query;
                    if((grouping==null && (category!=null || model!=null)) || (grouping==="category" && (category==null || model!=null))
                    || (grouping==="model" && (category!=null || model==null))) throw new Error();
                    return true;
                }),
                this.errorHandler.validateRequest
            ],
